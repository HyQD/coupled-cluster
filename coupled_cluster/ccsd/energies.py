...
def lagrangian_functional(f, u, t_1, t_2, l_1, l_2, o, v, np, test=False):
    ...
    term = (0.5) * np.tensordot(t_2, u[o, o, v, o], axes=((1, 2, 3), (2, 0, 1))) # ai
    energy += np.tensordot(l_1, term, axes=((0, 1), (1, 0)))
    term = (0.5) * np.tensordot(l_1, t_2, axes=((0), (2))) # abcj
    energy += np.tensordot(term, u[v, o, v, v], axes=((0, 1, 2, 3), (0, 2, 3, 1)))
    term = (0.5) * np.tensordot(l_2, t_1, axes=((2), (0))) # ijbk
    energy += np.tensordot(term, u[v, o, o, o], axes=((0, 1, 2, 3), (2, 3, 0, 1)))
    term = (0.5) * np.tensordot(l_2, t_1, axes=((0), (1))) # jabc
    energy += np.tensordot(term, u[v, v, v, o], axes=((0, 1, 2, 3), (3, 0, 1, 2)))
    ...
    term = (-0.5) * np.tensordot(t_1, u[o, o, v, v], axes=((0, 1), (3, 0))) # ja
    ...
    energy += np.tensordot(term, u[v, o, v, o], axes=((0, 1, 2, 3), (3, 0, 1, 2)))
    ...
    energy += np.tensordot(term, u[o, o, v, o], axes=((0, 1, 2, 3), (3, 0, 2, 1)))
    ...
    energy += np.tensordot(term, u[o, o, v, v], axes=((0, 1, 2, 3), (0, 2, 3, 1)))
    term = (-0.5) * np.tensordot(l_1, t_1, axes=((0), (1))) # ab
    term = np.tensordot(term, t_2, axes=((0), (0))) # bcjk
    energy += np.tensordot(term, u[o, o, v, v], axes=((0, 1, 2, 3), (2, 3, 0, 1)))
    ...
    term = (0.25) * np.tensordot(t_2, u[v, o, v, v], axes=((0, 1), (2, 3))) # ijbk
    term = np.tensordot(t_1, term, axes=((1), (3))) # aijb
    energy += np.tensordot(l_2, term, axes=((0, 1, 2, 3), (1, 2, 0, 3)))
    term = (0.25) * np.tensordot(t_2, u[o, o, v, o], axes=((2, 3), (0, 1))) # abcj
    ...
    energy += np.tensordot(l_1, term, axes=((0, 1), (1, 0))) 
    term = (-1) * np.tensordot(t_2, u[o, o, v, v], axes=((1, 3), (3, 1))) # bjkc
    ...
    term = (-0.5) * np.tensordot(t_1, u[o, o, v, v], axes=((0, 1), (2, 1))) # kd 
    ...
    energy += np.tensordot(term, u[o, o, v, o], axes=((0, 1, 2, 3), (3, 1, 0, 2)))
    term = (-0.5) * np.tensordot(l_2, t_1, axes=((0), (1))) # jabc
    ...
    energy += np.tensordot(term, u[o, o, v, v], axes=((0, 1, 2, 3), (1, 0, 2, 3)))
