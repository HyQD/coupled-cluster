...
def compute_t_1_amplitudes(F, W, t1, t2, o, v, np, out=None):
    ...
    del tau8
    tau9 = np.zeros((nocc, nocc, nocc, nvirt))
...
def compute_t_2_amplitudes(F, W, t1, t2, o, v, np, out=None):
    ...
    Omegb = np.zeros((nvirt, nvirt, nocc, nocc))
    ...
    del tau1
    tau2 = np.zeros((nocc, nocc, nvirt, nvirt))
    ...
    del tau12
    tau26 = np.zeros((nocc, nocc, nvirt, nvirt))
    ...
    del tau26
    tau13 = np.zeros((nocc, nocc, nocc, nocc))
    ...
    tau15 = np.zeros((nocc, nocc, nvirt, nvirt))
    ...
    tau23 = np.zeros((nocc, nocc, nvirt, nvirt))
    ...
    del tau17
    tau19 = np.zeros((nocc, nvirt, nvirt, nvirt))
    ...
    del tau33
    tau34 = np.zeros((nocc, nocc, nvirt, nvirt))
    ...
    tau46 = np.zeros((nocc, nocc, nvirt, nvirt))
    ...
    del tau49
    del tau14
    tau50 = np.zeros((nocc, nvirt, nvirt, nvirt))
    tau50 += np.einsum("aj,ijbc->iabc", t1, W[o, o, v, v], optimize=True)
    tau51 = np.zeros((nvirt, nvirt, nvirt, nvirt))
    ...
    del tau51
    tau52 = np.zeros((nocc, nocc, nvirt, nvirt))
    ...
    del tau52
    tau53 = np.zeros((nocc, nocc, nvirt, nvirt))
