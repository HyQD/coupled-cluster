...
def test_lagrangian_functional_zanghellini(
    ...
    ccd = CoupledClusterDoubles(zanghellini_system, verbose=True)
    ...
    lagrangian_auto += compute_reference_energy(f, u, o, v, np)
...
def test_lagrangian_functional(large_system_ccd):
    ...
    lagrangian_auto += compute_reference_energy(cs.f, cs.u, cs.o, cs.v, np)
