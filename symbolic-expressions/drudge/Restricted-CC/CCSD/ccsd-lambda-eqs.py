...
l1_eqn = dr.define(rhs[i,a],sim_HX1.eval_fermi_vev().simplify() + (lambd_op*sim_HX1).eval_fermi_vev().simplify())
l2_eqn = dr.define(rhs[i,j,a,b],sim_HX2.eval_fermi_vev().simplify()+(lambd_op*sim_HX2).eval_fermi_vev().simplify())
