...
def l1_rhs(f,u,l1,l2,t1,t2):
    ...
    rhs -= 2 * np.einsum(
        "bj,ijba->ia", t1, u[o,o,v,v]
    )

    rhs += 4 * np.einsum(
        "bj,ijab->ia", t1, u[o,o,v,v]
    )
    ...
    rhs += np.einsum(
        "ib,bckj,jkac->ia", l1, t2, u[o,o,v,v], optimize=True
    )

    rhs += np.einsum(
        "ja,bckj,ikbc->ia", l1, t2, u[o,o,v,v], optimize=True
    )

    rhs += np.einsum(
        "jb,bckj,ikca->ia", l1, t2, u[o,o,v,v], optimize=True
    )

    rhs -= 2 * np.einsum(
        "ib,jkac,bcjk->ia", f[o,v], l2, t2,optimize=True
    )

    rhs -= 2 * np.einsum(
        "ja,ikbc,bcjk->ia", f[o,v], l2, t2,optimize=True
    )
    ...
    rhs += 2 * np.einsum(
        "ijbc,bcaj->ia", l2, u[v,v,v,o], optimize=True
    )

    rhs -= np.einsum(
        "ib,cj,jbac->ia", l1, t1, u[o,v,v,v], optimize=True
    )

    rhs -= np.einsum(
        "jb,cj,ibca->ia", l1, t1, u[o,v,v,v], optimize=True
    )

    rhs += 2 * np.einsum(
        "ib,cj,bjac->ia", l1, t1, u[v,o,v,v], optimize=True
    )

    rhs += 2 * np.einsum(
        "jb,cj,ibac->ia", l1, t1, u[o,v,v,v], optimize=True
    )

    rhs -= np.einsum(
        "jb,ibja->ia", l1, u[o,v,o,v]
    )

    rhs += 2 * np.einsum(
        "jb,ibaj->ia", l1, u[o,v,v,o]
    )

    rhs -= np.einsum(
        "ib,ja,bj->ia", f[o,v], l1, t1,optimize=True
    )

    rhs -= np.einsum(
        "ja,ib,bj->ia", f[o,v], l1, t1,optimize=True
    )

    rhs -= 2 * np.einsum(
        "jkab,ibjk->ia", l2, u[o,v,o,o]
    )

    rhs += np.einsum(
        "ja,bk,ikbj->ia", l1, t1, u[o,o,v,o], optimize=True
    )

    rhs += np.einsum(
        "jb,bk,ikja->ia", l1, t1, u[o,o,o,v], optimize=True
    )

    rhs -= 2 * np.einsum(
        "ja,bk,ikjb->ia", l1, t1, u[o,o,o,v], optimize=True
    )

    rhs -= 2 * np.einsum(
        "jb,bk,ikaj->ia", l1, t1, u[o,o,v,o], optimize=True
    )
...
def l2_rhs(f,u,l1,l2,t1,t2):
    ...
    rhs -= np.einsum(
        "ic,cjba->ijab", l1, u[v,o,v,v]
    )

    rhs -= np.einsum(
        "jc,icba->ijab", l1, u[o,v,v,v]
    )

    rhs += 2 * np.einsum(
        "ca,ijcb->ijab", f[v,v], l2
    )

    rhs += 2 * np.einsum(
        "cb,ijac->ijab", f[v,v], l2
    )

    rhs += 2 * np.einsum(
        "ic,cjab->ijab", l1, u[v,o,v,v]
    )

    rhs += 2 * np.einsum(
        "jc,icab->ijab", l1, u[o,v,v,v]
    )
    ...
    rhs -= 2 * np.einsum(
        "ikac,cjbk->ijab", l2, u[v,o,v,o], optimize=True
    )

    rhs -= 2 * np.einsum(
        "ikbc,cjka->ijab", l2, u[v,o,o,v], optimize=True
    )

    rhs -= 2 * np.einsum(
        "ikcb,cjak->ijab", l2, u[v,o,v,o], optimize=True
    )

    rhs -= 2 * np.einsum(
        "kjac,ickb->ijab", l2, u[o,v,o,v], optimize=True
    )

    rhs -= 2 * np.einsum(
        "kjca,icbk->ijab", l2, u[o,v,v,o], optimize=True
    )

    rhs -= 2 * np.einsum(
        "kjcb,icka->ijab", l2, u[o,v,o,v], optimize=True
    )

    rhs += 4 * np.einsum(
        "ikac,cjkb->ijab", l2, u[v,o,o,v], optimize=True
    )

    rhs += 4 * np.einsum(
        "kjcb,icak->ijab", l2, u[o,v,v,o], optimize=True
    )

    rhs += np.einsum(
        "ib,ck,kjac->ijab", l1, t1, u[o,o,v,v], optimize=True
    )

    rhs += np.einsum(
        "ic,ck,kjba->ijab", l1, t1, u[o,o,v,v], optimize=True
    )

    rhs += np.einsum(
        "ja,ck,ikcb->ijab", l1, t1, u[o,o,v,v], optimize=True
    )

    rhs += np.einsum(
        "jc,ck,ikba->ijab", l1, t1, u[o,o,v,v], optimize=True
    )

    rhs += np.einsum(
        "ka,ck,ijbc->ijab", l1, t1, u[o,o,v,v], optimize=True
    )

    rhs += np.einsum(
        "kb,ck,ijca->ijab", l1, t1, u[o,o,v,v], optimize=True
    )

    rhs -= 2 * np.einsum(
        "ic,ck,kjab->ijab", f[o,v], t1, l2,optimize=True
    )

    rhs -= 2 * np.einsum(
        "jc,ck,ikab->ijab", f[o,v], t1, l2,optimize=True
    )

    rhs -= 2 * np.einsum(
        "ka,ck,ijcb->ijab", f[o,v], t1, l2,optimize=True
    )

    rhs -= 2 * np.einsum(
        "kb,ck,ijac->ijab", f[o,v], t1, l2,optimize=True
    )
    ...
    rhs += 2 * np.einsum(
        "ijcd,cdab->ijab", l2, u[v,v,v,v], optimize=True
    )

    rhs += np.einsum(
        "ka,ijbk->ijab", l1, u[o,o,v,o]
    )

    rhs += np.einsum(
        "kb,ijka->ijab", l1, u[o,o,o,v]
    )

    rhs -= 2 * np.einsum(
        "ik,kjab->ijab", f[o,o], l2
    )

    rhs -= 2 * np.einsum(
        "jk,ikab->ijab", f[o,o], l2
    )
    ...
    rhs -= 2 * np.einsum(
        "kb,ijak->ijab", l1, u[o,o,v,o]
    )

    rhs += 2 * np.einsum(
        "kmab,ijkm->ijab", l2, u[o,o,o,o]
    )
