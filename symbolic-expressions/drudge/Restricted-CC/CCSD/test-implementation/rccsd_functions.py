...
def t1_rhs(f,u,t1,t2):
    ...
    rhs += np.einsum(
        "ak,bcij,jkbc->ai", t1, t2, u[o,o,v,v], optimize=True
    )

    rhs += np.einsum(
        "ci,abjk,jkbc->ai", t1, t2, u[o,o,v,v], optimize=True
    )

    rhs += np.einsum(
        "ck,abji,jkcb->ai", t1, t2, u[o,o,v,v], optimize=True
    )
    ...
    rhs -= np.einsum(
        "bcij,ajcb->ai", t2, u[v,o,v,v]
    )

    rhs += 2 * np.einsum(
        "bcij,ajbc->ai", t2, u[v,o,v,v]
    )
    ...
    rhs += np.einsum(
        "abjk,kjib->ai", t2, u[o,o,o,v]
    )

    rhs -= 2 * np.einsum(
        "abjk,jkib->ai", t2, u[o,o,o,v]
    )
...
def t2_rhs(f,u,t1,t2):
    ...
    rhs += np.einsum(
        "ac,bcji->abij", f[v,v], t2
    )

    rhs += np.einsum(
        "bc,acij->abij", f[v,v], t2
    )

    rhs += np.einsum(
        "ci,abcj->abij", t1, u[v,v,v,o]
    )

    rhs += np.einsum(
        "cj,abic->abij", t1, u[v,v,o,v]
    )
    ...
    rhs -= np.einsum(
        "di,ackj,bkcd->abij", t1, t2, u[v,o,v,v], optimize=True
    )

    rhs -= np.einsum(
        "di,bcjk,akcd->abij", t1, t2, u[v,o,v,v], optimize=True
    )

    rhs -= np.einsum(
        "di,bckj,akdc->abij", t1, t2, u[v,o,v,v], optimize=True
    )

    rhs -= np.einsum(
        "dj,acik,bkcd->abij", t1, t2, u[v,o,v,v], optimize=True
    )

    rhs -= np.einsum(
        "dj,acki,bkdc->abij", t1, t2, u[v,o,v,v], optimize=True
    )

    rhs -= np.einsum(
        "dj,bcki,akcd->abij", t1, t2, u[v,o,v,v], optimize=True
    )

    rhs -= np.einsum(
        "dk,acij,bkdc->abij", t1, t2, u[v,o,v,v], optimize=True
    )

    rhs -= np.einsum(
        "dk,bcji,akdc->abij", t1, t2, u[v,o,v,v], optimize=True
    )
    ...
    rhs -= np.einsum(
        "kc,ak,bcji->abij", f[o,v], t1, t2
    )

    rhs -= np.einsum(
        "kc,bk,acij->abij", f[o,v], t1, t2
    )

    rhs -= np.einsum(
        "kc,ci,abkj->abij", f[o,v], t1, t2
    )

    rhs -= np.einsum(
        "kc,cj,abik->abij", f[o,v], t1, t2
    )
    ...
    rhs += np.einsum(
        "al,bcjk,klic->abij", t1, t2, u[o,o,o,v], optimize=True
    )

    rhs += np.einsum(
        "al,bcki,lkcj->abij", t1, t2, u[o,o,v,o], optimize=True
    )

    rhs += np.einsum(
        "al,bckj,lkic->abij", t1, t2, u[o,o,o,v], optimize=True
    )

    rhs += np.einsum(
        "bl,acik,lkcj->abij", t1, t2, u[o,o,v,o], optimize=True
    )

    rhs += np.einsum(
        "bl,acki,klcj->abij", t1, t2, u[o,o,v,o], optimize=True
    )

    rhs += np.einsum(
        "bl,ackj,klic->abij", t1, t2, u[o,o,o,v], optimize=True
    )
    ...
    rhs += np.einsum(
        "cl,abik,klcj->abij", t1, t2, u[o,o,v,o], optimize=True
    )

    rhs += np.einsum(
        "cl,abkj,lkic->abij", t1, t2, u[o,o,o,v], optimize=True
    )
    ...
    rhs -= np.einsum(
        "ki,abkj->abij", f[o,o], t2
    )

    rhs -= np.einsum(
        "kj,abik->abij", f[o,o], t2
    )
