from one_body_density_matrix import (
    ...
    get_ccsd_two_body_density_matrix,
...
print("One-body density matrix for CCSD:")
for label, (p, q) in symbol_list_one_body:
    print(label + latex(get_ccsd_one_body_density_matrix(p=p, q=q)))


print("\nTwo-body density matrix for CCSD:")
for label, (p, q, r, s) in symbol_list_two_body:
    print(label + latex(get_ccsd_two_body_density_matrix(p=p, q=q, r=r, s=s)))
